...
let mainRtaResults = function (optIn) {
  ...
  function topolino () {
    ...
    sock.widgetV[widgetType].SockFunc.topolino({ widgetId: widgetId })
  }
  this.topolino = topolino

  document.querySelector('base-app').addEventListener('topolino', function (e) {
          topolino()
  })
  ...
  let RtaResultsMain = function () {
    ...
    function updateData (dataIn) {
      ...
      if(dataIn && dataIn.data) {
        ...
        // Updating LC
        // ------------------
        //text, x, y, err_x, err_x_min, err_y, err_y_min, addUpperLimit, pointClass

        var up = (newP.isUpperLimit == 'true')
